        ...
        for ($i = 0; $i < $this->populasi; $i++) {
            ...
            for ($j = 0; $j < $jumlah_pengampu; $j++) {
                ...
                if ($this->jenis_kuliah[$j] === $this->REGULER) {
                    ...
                    if(empty($this->admin_models->filterJamSKS($this->jam, $this->range_sholat, $sks, $hari))){
                        $this->individu[$i][$j][1]=8;
                        continue;
                    }
        ...
        for ($i = 0; $i < $this->populasi; $i++) {
            ...
            if ($r < $this->mutasi) {
                ...
                if ($this->jenis_kuliah[$krom] === $this->REGULER) {
                    ...
                    if(empty($this->admin_models->filterJamSKS($this->jam, $this->range_sholat, $j, $hari))){
                        $this->individu[$i][$krom][1]=8;
                        continue;
                    }  
